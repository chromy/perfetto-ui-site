var perfetto = (function () {
	...
	*/
	...
	var myElement = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	class MyElement extends litElement.LitElement {
	    static get properties() { return { mood: String }; }
	    _render({ mood }) {
	        return litElement.html `<style> .mood { color: green; } </style>
	...
	const ViewerPage = {
	    view: function () {
	        return [
	            ...
	            mithril(Side),
	            mithril('#content', "No traces loaded", mithril('my-element[mood=happy]')),
	        ];
	    },
	};
