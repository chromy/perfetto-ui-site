var perfetto = (function () {
	...
	*/
	...
	var litExtended = /*#__PURE__*/Object.freeze({
		html: html$1,
		svg: svg$1,
	...
	var litElement = /*#__PURE__*/Object.freeze({
	...
	unwrapExports(trackCanvasController);
	var trackCanvasController_1 = trackCanvasController.CanvasController;
	...
	var html$2 = parser("text/html");

	var svg$2 = parser("image/svg+xml");
	...
	var cpuTimeline = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.CpuTimeline = CpuTimeline;
	...
	class GlobalBrushTimeline extends litElement.LitElement {
	    constructor(state, width, onBrushed) {
	        super();
	        this.state = state;
	        this.width = width;
	        this.start = 0;
	...
	exports.GlobalBrushTimeline = GlobalBrushTimeline;
	customElements.define('global-brush-timeline', GlobalBrushTimeline);

	});

	unwrapExports(globalBrushTimeline);
	var globalBrushTimeline_1 = globalBrushTimeline.GlobalBrushTimeline;

	var trackShell = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });


	class TrackShell extends litElement.LitElement {
	...
	unwrapExports(trackShell);
	var trackShell_1 = trackShell.TrackShell;

	var trackContent = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	unwrapExports(trackContent);
	var trackContent_1 = trackContent.TrackContent;
	...
	class SliceTrackContent extends trackContent.TrackContent {
	    ...
	    draw() {
	        ...
	        const slices = traceDataStore.traceDataStore.getData({
	            start: 0,
	            end: 14000,
	            process: 1,
	            thread: 1,
	        ...
	        for (const slice of slices) {
	            this.tCtx.fillRect(this.x(slice.start), 0, this.x(slice.end) - this.x(slice.start), 20);
	        }
	...
	exports.SliceTrackContent = SliceTrackContent;
	...
	class Track extends litElement.LitElement {
	    constructor(state, globalState, tCtx, width) {
	        super();
	        this.state = state;
	        ...
	        const contentCtx = new trackCanvasController.TrackCanvasContext(this.tCtx, cp.left + this.shellWidth, cp.top);
	        ...
	        this.content = new sliceTrackContent.SliceTrackContent(contentCtx, contentWidth); //TODO: Infer
	        this.shell = new trackShell.TrackShell(this.content.height, this.shellWidth, this.state.metadata.name);
	    ...
	    _render() {
	        if (this.state) ;
	        this.content.setLimits(this.globalState.gps.startVisibleWindow, this.globalState.gps.endVisibleWindow);
	...
	var trackTree = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	    ...
	    updateChildren() {
	        ...
	        for (let childState of this.state.children) {
	            ...
	            const child = TrackTree.isTrackTreeState(childState) ?
	                ...
	                new track.Track(childState, this.globalState, tCtx, reducedWidth);
	...
	exports.TrackTree = TrackTree;
	customElements.define('track-tree', TrackTree);

	});

	unwrapExports(trackTree);
	var trackTree_1 = trackTree.TrackTree;

	var panContent = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });


	class PanContent extends litElement.LitElement {
	    //private mouseXpos: number = 0;
	    constructor(width, windowHeight, state, onPanned, onScrolled) {
	        super();
	        this.width = width;
	    ...
	    _render() {
	        this.timeToWidthRatio = (this.state.gps.endVisibleWindow -
	            this.state.gps.startVisibleWindow) / this.width;
	        const scrollerContent = litElement.html `
    <style>
      .scroller-content {
	...
	class TraceUi extends litElement.LitElement {
	    constructor(state, width) {
	        ...
	        this.cc = new trackCanvasController.CanvasController(this.width, canvasHeight, window.innerHeight, reRender);
	        const tCtx = this.cc.getTrackCanvasContext();
	        const contentWidth = this.width - TraceUi.SCROLLBAR_WIDTH;
	        this.root = new trackTree.TrackTree(this.state.trackTree, this.state, tCtx, contentWidth);
	        ...
	        this.pc = new panContent.PanContent(this.width, window.innerHeight, this.state, reRender, (scrollTop) => this.cc.setScrollTop(scrollTop));
	...
	unwrapExports(traceUi);
	var traceUi_1 = traceUi.TraceUi;
	...
	const ViewerPage = {
	    oncreate: function (vnode) {
	        ...
	        const ui = new traceUi.TraceUi(state$$1, rect.width);
	...
	function main() {
	    ...
	    window.query = () => processor.postMessage({
	        topic: 'query',
	    });
	...
	var main$2 = unwrapExports(main$1);
